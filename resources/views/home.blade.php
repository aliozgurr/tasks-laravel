...
@section('content')
    <div>
        <h3 class="text-2xl font-bold mb-8">Estimated Completion For Current Tasks: {{ $latestFinishingTask->humanized_estimated_completion_date }}</h3>
    </div>
    <div id="app">
        <div class="sprints">
            ...
            <div class="flex flex-wrap lg:gap-8 gap-4">
                <div v-for="task in tasks">
                    <div
                        ...
                        <div class="mt-3">
                            <span class="mb-2 text-xl font-bold tracking-tight text-gray-900" v-text="'#' + task.id"></span>
                        </div>
                        <div>
                            <span class="mb-2 text-l font-bold tracking-tight text-gray-900" v-text="task.name"></span>
                        </div>
                        <div>
                            <span class="mb-2 text-l font-bold tracking-tight text-gray-900" v-text="task.sprint_name"></span>
                        </div>
                        <div>
                            <span class="mb-2 text-m font-medium tracking-tight text-gray-900" v-text="'Assignee: ' + task.developer_name"></span>
                        </div>
